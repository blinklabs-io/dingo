...
// Returns a map of certificate index to deposit amount (including zero values).
//
...
//
// All other certificate types (delegations, deregistrations, updates, etc.) have no deposits.
