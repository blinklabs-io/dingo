...
Migration `v24` (`leios-key-registration-effective-epoch`, integer version
24) adds the nullable registration-effective epoch to pool stake snapshots.
Migration `v25` (`leios-imported-key-age-unknown`, integer version 25) marks
