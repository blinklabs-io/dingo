...
The snapshot base directory and its ancestors should already be durable; syncing
the immediate parent does not establish durability of newly created ancestors.
