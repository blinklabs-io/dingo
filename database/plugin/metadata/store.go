...
type MetadataStore interface {
	...
	// registration holds -- the amount its first registration paid, not what
	// the current protocol parameters would charge. Used to apply POOLREAP
	// deposit refunds at the epoch boundary.
