...
func (d *MetadataStoreSqlite) UpdatePoolOpCertSequence(
	pkh lcommon.PoolKeyHash,
	sequence uint64,
	slot uint64,
	txn types.Txn,
...
func (d *MetadataStoreSqlite) LatestPoolOpCertSequence(
	pkh lcommon.PoolKeyHash,
	txn types.Txn,
) (uint64, bool, error) {
	db, err := d.resolveReadDB(txn)
...
func (d *MetadataStoreSqlite) GetEpochBoundaryStakeByPools(
	poolKeyHashes [][]byte,
	snapshotSlot uint64,
	boundarySlot uint64,
	expiryEpoch uint64,
