...
func (d *MetadataStoreSqlite) DeactivateAccounts(
	...
	return importutil.DeactivateAccounts(db, creds, sqliteBindVarLimit)
}
...
func (d *MetadataStoreSqlite) DeactivateDreps(
	...
	return importutil.DeactivateDreps(db, creds, sqliteBindVarLimit)
}
...
func (d *MetadataStoreSqlite) RetirePools(
	...
	return importutil.RetirePools(
		db, poolKeyHashes, epoch, addedSlot, sqliteBindVarLimit,
	)
}
