...
func (d *MetadataStoreSqlite) AddEndorserTransactions(
	hashes [][]byte,
	rbSlot uint64,
	txn types.Txn,
) error {
...
func (d *MetadataStoreSqlite) FilterEndorserTransactions(
	hashes [][]byte,
	txn types.Txn,
) ([][]byte, error) {
	if len(hashes) == 0 {
...
func (d *MetadataStoreSqlite) UtxoSpenders(
	producerHashes [][]byte,
	txn types.Txn,
) ([][]byte, error) {
...
func (d *MetadataStoreSqlite) RevokeEndorserTransactions(
	hashes [][]byte,
	txn types.Txn,
) error {
	if len(hashes) == 0 {
...
func (d *MetadataStoreSqlite) DeleteEndorserTransactionsAfterSlot(
	slot uint64,
	txn types.Txn,
) error {
	db, err := d.resolveDB(txn)
