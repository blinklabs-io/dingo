...
func (d *MetadataStoreSqlite) SaveRewardStakeInputs(
...
func (d *MetadataStoreSqlite) GetRewardStakeInputs(
	epoch uint64,
	txn types.Txn,
) ([]*models.RewardStakeInput, error) {
	db, err := d.resolveReadDB(txn)
...
func (d *MetadataStoreSqlite) DeleteRewardInputsForEpoch(
	epoch uint64,
	txn types.Txn,
) error {
	db, err := d.resolveDB(txn)
...
func (d *MetadataStoreSqlite) DeleteRewardOutputsForEpoch(
	epoch uint64,
	txn types.Txn,
) error {
	db, err := d.resolveDB(txn)
...
func (d *MetadataStoreSqlite) SaveRewardPoolOutputs(
...
func (d *MetadataStoreSqlite) GetRewardPoolOutputs(
	epoch uint64,
	txn types.Txn,
...
func (d *MetadataStoreSqlite) SaveRewardAccountOutputs(
...
func (d *MetadataStoreSqlite) GetRewardAccountOutputs(
	epoch uint64,
	txn types.Txn,
