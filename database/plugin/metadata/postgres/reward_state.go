...
func (d *MetadataStorePostgres) GetRewardStakeInputsAtSlot(
	poolKeyHashes [][]byte,
	slot uint64,
	txn types.Txn,
...
func (d *MetadataStorePostgres) SaveRewardStakeInputs(
...
func (d *MetadataStorePostgres) GetRewardStakeInputs(
	epoch uint64,
	txn types.Txn,
) ([]*models.RewardStakeInput, error) {
	db, err := d.resolveReadDB(txn)
...
func (d *MetadataStorePostgres) DeleteRewardInputsForEpoch(
	epoch uint64,
	txn types.Txn,
) error {
	db, err := d.resolveDB(txn)
...
func (d *MetadataStorePostgres) DeleteRewardOutputsForEpoch(
	epoch uint64,
	txn types.Txn,
) error {
	db, err := d.resolveDB(txn)
...
func (d *MetadataStorePostgres) SaveRewardPoolOutputs(
...
func (d *MetadataStorePostgres) GetRewardPoolOutputs(
	epoch uint64,
	txn types.Txn,
...
func (d *MetadataStorePostgres) SaveRewardAccountOutputs(
...
func (d *MetadataStorePostgres) GetRewardAccountOutputs(
	epoch uint64,
	txn types.Txn,
