...
func (d *MetadataStorePostgres) UpdatePoolOpCertSequence(
	pkh lcommon.PoolKeyHash,
	sequence uint64,
	slot uint64,
	txn types.Txn,
...
func (d *MetadataStorePostgres) LatestPoolOpCertSequence(
	pkh lcommon.PoolKeyHash,
	txn types.Txn,
) (uint64, bool, error) {
...
func (d *MetadataStorePostgres) GetEpochBoundaryStakeByPools(
	poolKeyHashes [][]byte,
	snapshotSlot uint64,
	boundarySlot uint64,
	expiryEpoch uint64,
