...
// TestPostgresReconcileRoundTrip exercises the shared importutil reconcile
// helpers against a real postgres: chunked tag-grouped deactivation and
// duplicate-safe synthetic pool retirement.
func TestPostgresReconcileRoundTrip(t *testing.T) {
