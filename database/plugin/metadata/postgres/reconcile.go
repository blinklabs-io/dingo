...
func (d *MetadataStorePostgres) DeactivateAccounts(
	...
	return importutil.DeactivateAccounts(db, creds, postgresBatchChunkSize)
}
...
func (d *MetadataStorePostgres) DeactivateDreps(
	...
	return importutil.DeactivateDreps(db, creds, postgresBatchChunkSize)
}
...
func (d *MetadataStorePostgres) RetirePools(
	...
	return importutil.RetirePools(
		db, poolKeyHashes, epoch, addedSlot, postgresBatchChunkSize,
	)
}
