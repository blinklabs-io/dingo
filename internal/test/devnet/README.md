...
unavailable to txpump for 600 slots on canonical runs. `--accelerated` selects
100 slots (50 seconds at the accelerated slot length), allowing further rounds
within the scenario budget. This delay reduces immediate dependency reuse;
