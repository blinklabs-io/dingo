...
var flagSpecs = []flagSpec{
	...
	stringFlag("LeiosVoteSigningKeyFile", "leios-vote-signing-key-file", "", "path to Cardano text-envelope BLS12-381 Leios vote signing key or legacy raw hexadecimal scalar"),
