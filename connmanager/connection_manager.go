...
func (c *ConnectionManager) updateConnectionMetrics() {
	...
	c.metrics.fullDuplexConns.Set(
		0,
	) // TODO: Implement full duplex connection detection
	c.metrics.prunableConns.Set(0) // TODO: Implement prunable logic
}
