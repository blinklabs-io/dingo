...
CIP-conformant path when an EB is unavailable is obsolete. Standard Leios
profiles run Dijkstra validation and reject every disagreement, including
Plutus evaluation disagreements. Only the explicit Musashi prototype bypass
skips validation and trusts its disagreements.
