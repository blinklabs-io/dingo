...
- **Rate limiting can be disabled:** Transaction submission is easier to tweak because setting the submission rate limit to `0` now disables throttling.
...
- **Rate limit `0` now means “disabled”:** Throughput may change after upgrading if you used a submission rate limit of `0` expecting a default or minimal limit.
