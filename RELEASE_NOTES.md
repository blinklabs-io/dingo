...
**Title:** Reliability and performance patch
...
- **Patch release:** This update focuses on solid reliability and performance tweaks rather than introducing new features.
...
- **API bind address:** If you relied on config validation auto-defaulting the API bind address, set it explicitly in your config.
