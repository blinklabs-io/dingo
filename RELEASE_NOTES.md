...
* Corrected **steadier peer sharing:** Dingo no longer asks peers for peer sharing when those peers have it turned off or do not support peer sharing, so nodes avoid protocol errors and connection resets.
