...
- **Trusted block replay:** Resuming and validating chain history is more rock-solid because the block replay path is now safer and more flexible.
...
- **Mithril Docker setup:** Containerized Mithril setups are easier because the entrypoint can auto-load the Mithril genesis verification key when you don’t provide one.
