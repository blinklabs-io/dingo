...
* Refreshed **keep Google API integrations aligned with newer client support:** Google API backed integrations now track a newer client release, which supports steadier compatibility. (`5a67ea8`)
...
* Cleaned **update build automation to the latest checkout workflow generation:** Project automation now uses the newer checkout action generation across CI and publish workflows. (`474ca48`)
