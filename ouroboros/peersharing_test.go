...
func TestPeerSharingShareRequestBoundsValidPeers(t *testing.T) {
	...
	require.NoError(
		t,
		peerGov.AddPeer("malformed", peergov.PeerSourceP2PGossip),
	)
	require.NoError(
		t,
...
func TestPeerSharingReplyRejectsAddressClasses(t *testing.T) {
	...
	tests := []struct {
		...
		{"ipv4 test-net-1", mkPeerAddr("192.0.2.1", 3001)},
		{"ipv4 test-net-2", mkPeerAddr("198.51.100.1", 3001)},
		{"ipv4 test-net-3", mkPeerAddr("203.0.113.1", 3001)},
		...
		{"ipv6 documentation", mkPeerAddr("2001:db8::1", 3001)},
